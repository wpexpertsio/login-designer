...
class LoginDesigner_Background_Control extends WP_Customize_Upload_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->button_labels = apply_filters( 'login_designer_background_button_labels', $button_labels, $id );

		// Set field labels.
		$field_labels = $this->get_field_labels();
		$this->field_labels = apply_filters( 'login_designer_background_field_labels', $field_labels, $id );

		// Set background choices.
		$background_choices = $this->get_background_choices();
		$this->background_choices = apply_filters( 'login_designer_background_choices', $background_choices, $id );
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'login-designer-background-control', $js_dir . 'login-designer-customize-background-control' . $suffix . '.js', array( 'jquery' ), LOGIN_DESIGNER_VERSION, 'all' );
	}
