...
function loginly_action_links( $links, $file ) {
	...
	if ( $file === $this_plugin ) {
		...
		$pro_link = sprintf( esc_html__( '%1$s %3$s Go Pro %4$s %2$s', '@@textdomain' ),  '<a href="https://loginlywp.com/?utm_source=loginly-lite&utm_medium=plugin-action-link&utm_campaign=pro" target="_blank">', '</a>', '<span class="loginly-plugin-title__link--green">', '</span>' );
